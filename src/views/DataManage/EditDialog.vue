<template>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="$emit('closeDialog')" size="samll">取消</el-button>
...
@Component
export default class EidtDialog extends Vue {
  // 属性或者参数中使用(!): 表示强制解析 （告诉typescript编辑器，这里一定有值），常用于vue-decorator 中的@Prop
